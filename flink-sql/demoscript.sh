...
/opt/cloudera/parcels/CDH/bin/kafka-topics --create --bootstrap-server 10.113.197.84:9092 --replication-factor 1 --partitions 1 --topic global_sensor_events

/opt/cloudera/parcels/CDH/bin/kafka-topics --create --bootstrap-server 10.113.197.84:9092 --replication-factor 1 --partitions 1 --topic energy

/opt/cloudera/parcels/CDH/bin/kafka-topics --create --bootstrap-server 10.113.197.84:9092 --replication-factor 1 --partitions 1 --topic scada
...
fanstatus STRING
	...
	'connector.properties.bootstrap.servers' = '10.113.197.84:9092',
